...
class Gyroscope(Sensor):
    ...
    def __init__(self, position, opts):
        super().__init__(position, SensorType.GYROSCOPE)
    ...
    def measure(self, angle_difference, time_difference):
        ...
        w += get_gaussian_noise_sample(0, self.std_noise)
        w += get_gaussian_noise_sample(0, self.std_bias)
