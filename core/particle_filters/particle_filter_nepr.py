...
class ParticleFilterNEPR(ParticleFilterSIR):
    ...
    def __init__(self,
        ...
        super().__init__(number_of_particles, limits, process_noise, measurement_noise, resampling_algorithm)
    ...
    def needs_resampling(self):
        ...
        """
        #
        sum_weights_squared = self.particles.sum_weights_squared()

        return 1.0 / (sum_weights_squared + 1e-10) < self.resampling_threshold
